...
import com.oa.core.common.constant.cache.Cache;
import com.oa.core.common.constant.factory.ConstantFactory;
import com.oa.core.common.node.ZTreeNode;
...
import com.oa.core.util.CacheUtil;
import com.oa.modular.system.entity.Relation;
import com.oa.modular.system.entity.Role;
import com.oa.modular.system.entity.User;
import com.oa.modular.system.entity.VariableEnum;
import com.oa.modular.system.mapper.RelationMapper;
import com.oa.modular.system.mapper.RoleMapper;
import com.oa.modular.system.model.RoleDto;
...
public class RoleService extends ServiceImpl<RoleMapper, Role> {
     ...
     * @return
     */
    public String selectDeptNameRolePName(){
        Long userId = ShiroKit.getUserNotNull().getId();
        User user = this.userService.getById(userId);
        Role role = roleMapper.selectById(user.getRoleId());
        Role r = roleMapper.selectById(role.getPid());
        if (r.getName().equals(VariableEnum.DS.getPersonnel())||r.getName().equals(VariableEnum.Sum.getPersonnel())||r.getName().equals(VariableEnum.FSum.getPersonnel())){
            return r.getName();
        }
        return ShiroKit.getUserNotNull().getDeptName()+r.getName();
    }
}
