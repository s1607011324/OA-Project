...
import com.oa.core.common.constant.DefaultAvatar;
...
import com.oa.modular.system.factory.UserFactory;
...
public class SystemController extends BaseController {
    ...
    public String userInfo(Model model) {
        ...
        FileInfo fileInfo = fileInfoService.getById(user.getAvatar());
        if (fileInfo != null) {
            model.addAttribute("filePath",fileInfo.getFileData());
        }
    ...
    @ResponseBody
    public Object uploadAvatar(String avatar, @RequestParam(value = "file", required = false) MultipartFile file) {
        FileInfo fileInfo = fileInfoService.uploadAvatar(file,avatar);
    ...
    @ResponseBody
    public Object previewAvatar(HttpServletResponse response,HttpServletRequest request) {
